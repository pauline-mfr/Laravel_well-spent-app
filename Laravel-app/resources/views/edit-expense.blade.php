...
<div class="expenses-form mx-auto w-50">
  ...
  <div class="mb-3">
    ...
    <input type="text" step="any" name="title" class="form-control" value="{{ old('title', $expense->title) }}">
    <label for="amount" class="form-label text-primary">Amount </label>
    <input type="number" step="any" name="amount" class="form-control" value="{{ old('amount', $expense->amount) }}"><br>
    <label for="category" class="form-label text-primary">New category</label>
    <input type="text" step="any" name="category" class="form-control" value="{{ old('category', $expense->category) }}"><br>
